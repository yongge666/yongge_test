...
<!--                                                <a class="normal f12" href="javascript:void(0)" id="addressToggleButton" onclick="orderFormInstance.addressModToggle();">[退出]</a>-->
                                            ...
                                            <label class="btn_orange3" id='address_save_button'><input type="button" value="确认收货人地址" onclick="address_save();" /></label>
                                        </div>
                                        <!--地址管理 结束-->
...
$(function(){
    //选中默认
    //alert($('#addressChose').length);
    address_save();// $('#address_save_button input').triggle('click');
    $("#addressChose").trigger("click");
