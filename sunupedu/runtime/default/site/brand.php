...
<div class="wrapper clearfix container_2">
	<div class="sidebar f_l">
		<div class="box_2 m_10">
			...
			<div class="content">
				<ul class="brand_list">
				<?php foreach(Api::run('getBrandCategory',20) as $key => $item){?>
	...
	<div class="main f_r">
		...
		<?php if(isset($name) && $name != ''){?>
			...
			<div class="cont">
				<ul class="piclist_2">
					...
					<?php foreach(Api::run('getBrandListWhere',array('#id#',$id),100) as $key => $item){?>
					<li>
		...
		<?php }else{?>
			...
			<div class="cont">
				<ul class="piclist_2">
					<?php foreach(Api::run('getBrandList',40) as $key => $item){?>
					<li>
