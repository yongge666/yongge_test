		...
		<div class="box_2 m_10">
			...
			<div class="content">
				<ul class="prolist clearfix">
					<li>
						<a href="<?php echo IUrl::creatUrl("/site/products/id/".$id."");?>"><img src="<?php echo IUrl::creatUrl("/pic/thumb/img/".$item['img']."/w/212/h/167");?>" title="<?php echo isset($item['name'])?$item['name']:"";?>" alt="<?php echo isset($item['name'])?$item['name']:"";?>" height="212" width="167"></a>
						<p class="pro_title">商品名称：<a class="blue" href="<?php echo IUrl::creatUrl("/site/products/id/".$id."");?>"><?php echo isset($item['name'])?$item['name']:"";?></a></p>
						...
						<p>评论数：<?php echo isset($comment_total)?$comment_total:"";?>条</p>
					</li>
					<input type="submit" onclick="joinCart_list(<?php echo isset($id)?$id:"";?>);" value="加入购物车" class="submit_join m_10">
				</ul>
			</div>
		</div>
	</div>
