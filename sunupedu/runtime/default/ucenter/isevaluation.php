...
<div class="ucenter container">
	...
	<table class="list_table m_10" width="100%" cellpadding="0" cellspacing="0">
		...
		<tbody>
			...
			<tr>
				<td><a href="<?php echo IUrl::creatUrl("/site/comments_list/id/".$item['goods_id']."");?>" target="_block"><?php echo isset($item['name'])?$item['name']:"";?></a></td><td><?php echo isset($item['order_no'])?$item['order_no']:"";?></td><td><?php echo isset($item['comment_time'])?$item['comment_time']:"";?></td><td><?php echo isset($item['point'])?$item['point']:"";?></td><td><span class="green bold">已评价</span></td>
			</tr>
			<?php }?>
		</tbody>
