...
<div class="ucenter container">
	...
	<div class="box m_10">
		<table class="border_table" width="100%" cellpadding="0" cellspacing="0">
			...
			<tr>
				<th>退款商品：</th>
				<?php $goodsInfo = JSON::decode($this->data['goods']['goods_array'])?>
				<td><a class="blue" href="<?php echo IUrl::creatUrl("/site/products/id/".$this->data['goods_id']."");?>" href="_blank"><?php echo isset($goodsInfo['name'])?$goodsInfo['name']:"";?> <?php if($goodsInfo['value']){?><?php echo isset($goodsInfo['value'])?$goodsInfo['value']:"";?><?php }?> X <?php echo isset($this->data['goods']['goods_nums'])?$this->data['goods']['goods_nums']:"";?>件</a></td>
			</tr>
