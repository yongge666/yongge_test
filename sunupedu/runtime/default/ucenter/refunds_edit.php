			...
			<table class="border_table" width="100%" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td>
						...
						<p>
							<label>
								<input type="radio" name="order_goods_id" value="<?php echo isset($good['id'])?$good['id']:"";?>" />
