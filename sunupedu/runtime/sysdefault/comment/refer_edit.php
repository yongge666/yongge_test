...
<div class="headbar">
	...
	<div class="operating">
		<a onclick="location='<?php echo IUrl::creatUrl("/comment/refer_del/check/".$item['id']."");?>'" href="javascript:void(0);"><button class="operating_btn" type="button"><span class="delete">删除</span></button></a>
...
<div class="content_box">
	<div class="content form_content">
		<form action="<?php echo IUrl::creatUrl("/comment/refer_reply");?>" method="post" name="refer_edit">
			...
			<table class="form_table">
				...
				<tr>
					<th>咨询时间：</th><td><?php echo isset($item['time'])?$item['time']:"";?></td>
				</tr>
				<tr>
					<th>咨询内容：</th><td><?php echo isset($item['question'])?$item['question']:"";?></td>
				</tr>
				<tr>
					<th valign="top">回复：</th><td><textarea name="content" rows="" cols=""><?php echo isset($item['answer'])?$item['answer']:"";?></textarea></td>
				</tr>
				<tr>
