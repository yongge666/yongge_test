...
<div class="content_box">
	<div class="content form_content">
		<form action="<?php echo IUrl::creatUrl("/member/seller_payment_save");?>" method="post" name="sellerForm" enctype='multipart/form-data'>
			...
			<table class="form_table">
				...
				<tbody>
					<input class="normal" name="seller_id" type="hidden" value="<?php echo $this->seller_id;?>" pattern="required" />
					<!-- <tr>
						<th>合作者身份（PID）:</th>
						<td><input class="normal" name="parent_id" type="text" value="" pattern="required" /></td>
					</tr>
					
					<tr>
						<th>安全校验码（Key）:</th>
						<td><input class="normal" name="parent_key" type="text" value="" pattern="required" /></td>
					</tr> -->
					
					<tr>
						<th>收款账户 (Email或手机号) :</th>
						<td><input class="normal" name="parent_email" type="text" value="" pattern="required" /></td>
					</tr>
...
$(function(){
	//修改模式
	<?php if(isset($this->paymentRow) && $this->paymentRow){?>
