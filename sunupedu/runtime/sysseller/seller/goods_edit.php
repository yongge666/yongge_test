...
<article class="module width_full">
	...
	<form action="<?php echo IUrl::creatUrl("/seller/goods_update");?>" name="goodsForm" method="post">
		...
		<div class="module_content" id="table_box_1">
			...
			<fieldset>
				<label>书号</label>
				<input name="book_num" type="text" value="" initmsg="书号填写正确" pattern="required" alt="商品名称不能为空" onblur="" />
			</fieldset>

			<fieldset>
				<label>印张</label>
				<input name="seal" type="text" value="" initmsg="印张填写正确" pattern="required" alt="商品名称不能为空" onblur="" />
			</fieldset>

			<fieldset>
				<label>版别</label>
				<input name="book_version" type="text" value="" initmsg="版别填写正确" pattern="required" alt="商品名称不能为空" onblur="" />
			</fieldset>

			<fieldset>
				<label>出版社信息</label>
				<input name="publishing_info" type="text" value="" initmsg="出版社信息填写正确" pattern="required" alt="商品名称不能为空" onblur="" />
			</fieldset>
