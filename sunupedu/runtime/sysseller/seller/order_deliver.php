				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<input type="checkbox" name="sendgoods[]" value="<?php echo isset($item['id'])?$item['id']:"";?>"  checked="checked"/>
							<?php }else{?>
			...
			<table class="tablesorter clear">
				...
				<tbody>
					...
					<tr>
						...
						<th style="display: none;" >电话:</th><td style="display: none;" align="left"><input type="text" class="small" name="telphone" value="<?php echo isset($telphone)?$telphone:"";?>" pattern="phone" empty /></td>
					</tr>
					<tr>
						<th>手机:</th><td align="left"><input type="text" class="small" name="mobile" value="<?php echo isset($mobile)?$mobile:"";?>" pattern="mobi"/></td>
						<th style="display: none;" >邮政编码:</th><td style="display: none;" align="left"><input type="text" name="postcode" class="small" value="<?php echo isset($postcode)?$postcode:"";?>" pattern="zip" empty /></td>
					</tr>
					...
					<tr>
						<th style="display: none;" >地址:</th><td style="display: none;"  align="left" colspan="3"><input type="text" class="normal" name="address" value="<?php echo isset($address)?$address:"";?>" size="50" /></td>
					</tr>
					<tr>
