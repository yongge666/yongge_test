...
class sendgoods
{
	...
	private static function getOrderInfo($orderId)
	{
		...
		$orderDB->fields = 'p.class_name,o.trade_no,o.seller_id,dd.delivery_code,fc.freight_type,o.pay_type';
	...
	private static function createObject($className)
	{
		...
		switch($className)
		{
			...
			break;
			case "platform_assure_alipay":
			{
				include($basePath.'platform_assure_alipay/sendgoods_platform_assure_alipay.php');
				return new sendgoods_platform_assure_alipay();
			}
			break;
		}
		return '';
