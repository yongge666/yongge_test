...
$address = IFilter::act(IReq::get('address'));
		...
		$data = array('user_id'=>($user_id+1),'accept_name'=>$accept_name,'province'=>$province,'city'=>$city,'area'=>$area,'school'=>$school,'grade'=>$grade,'class'=>$class,'address'=>$address,'zip'=>$zip,'telphone'=>$telphone,'mobile'=>$mobile,'default'=>$default);
