...
class Order extends IController
{
    ...
    public function order_update()
    {
		...
		$orderFee    = $countSumObj->countOrderFee($goodsResult['sum'],$goodsResult['final_sum'],$goodsResult['weight'],$dataArray['distribution'],$dataArray['pay_type'],$goodsResult['freeFreight'],$dataArray['if_insured'],$dataArray['invoice'],$dataArray['discount']);
	...
	public function order_report()
	{
		...
		$strTable .= '<td style="text-align:center;font-size:12px;width:120px;">商家id</td>';
			...
			$strTable .= '<td style="text-align:center;font-size:12px;width:120px;">学生送货区</td>';
